...
public class DeviceControlActivity extends Activity {
    ...
    private static DeviceControlActivity instance;
...
private SharedPreferences sharedPref;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        sharedPref = DeviceControlActivity.this.getPreferences(Context.MODE_PRIVATE);
        cxt = getApplicationContext();
        stats = (Button) findViewById(R.id.stats);
        stats.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(DeviceControlActivity.this , data_activity.class));
            }
        });
       // hm.put("Sitting" , 0);
       // hm.put("Staying still" , 0);
        //hm.put("Walking" , 0);
        //hm.put("Running" , 0);
    ...
    private void displayData(String data) {
        if (data != null) {
            ...
            int value = sharedPref.getInt(data.trim() , 0);
            ref.child(data.trim()).setValue(value+1);

            //hm.put(data.trim() , value+1);
            refresh();
        }
    }
